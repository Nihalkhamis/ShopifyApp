...
public final class MapDialogBinding implements ViewBinding {
  ...
  private MapDialogBinding(@NonNull ConstraintLayout rootView, @NonNull TextView locationTxt,
  ...
  public static MapDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.map_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MapDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MapDialogBinding((ConstraintLayout) rootView, locationTxt, saveBtn);
    }
